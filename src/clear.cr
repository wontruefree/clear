...
#
# Instead of working on an adapter for a different database, I wanted to offer the
# maximum features for a specific platform.
#
# It's not every day we chose a database layout, and there are few reasons for you
